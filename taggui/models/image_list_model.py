...
class ImageListModel(QAbstractListModel):
    ...
    def data(self, index, role=None) -> Union[Image, str, QIcon, QSize]:
    ...
    def is_image_in_scope(self, scope: Union[Scope, str], image_index: int, image: Image) -> bool:
    ...
    def get_text_match_count(self, text: str, scope: Union[Scope, str], whole_tags_only: bool) -> int:
    ...
    def find_and_replace(self, find_text: str, replace_text: str, scope: Union[Scope, str]):
    ...
    def add_tags_json(self, tags: list[str], image_indices: list[QModelIndex]):
        """Add one or more tags to one or more images."""
        if not image_indices:
            return
        action_name = f'Add {pluralize("Tag", len(tags))}'
    ...
    def rename_tags(self, old_tags: List[str], new_tag: str,
                    scope: Union[Scope, str] = Scope.ALL_IMAGES):
